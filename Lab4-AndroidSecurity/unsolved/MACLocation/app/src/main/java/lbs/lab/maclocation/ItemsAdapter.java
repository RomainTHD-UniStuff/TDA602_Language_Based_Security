...
class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ViewHolder> {
    ...
    private final ArrayList<Item> mItemsData;
    ...
    @NonNull
    @Override
    public ItemsAdapter.ViewHolder onCreateViewHolder(
    ...
    public void onBindViewHolder(
        @NonNull ItemsAdapter.ViewHolder holder,
        int position
    ) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            detailIntent.putExtra(
                DetailActivity.TITLE_DATA,
                currentItem.getTitle()
            );
            detailIntent.putExtra(
                DetailActivity.INFO_DATA,
                currentItem.getInfo()
            );
